...
sl$`Evidence for cultivation` = gsub("inf","inferred without supporting evidence", sl$`Evidence for cultivation`)
...
sl$`Evidence for domestication` = gsub("inf","inferred without supporting evidence", sl$`Evidence for domestication`)
